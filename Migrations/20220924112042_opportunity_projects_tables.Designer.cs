...
namespace Backend.Migrations
{
    ...
    [Migration("20220924112042_opportunity_projects_tables")]
    partial class opportunity_projects_tables
    {
            ...
            modelBuilder.Entity("Backend.Models.Opportunity", b =>
                {
                    ...
                    b.Property<int?>("CurrentProposalValueCurrncey")
                        .HasColumnType("integer");

                    b.Property<double?>("FinalContractValue")
                        .HasColumnType("double precision");

                    b.Property<int?>("FinalContractValueCurrncey")
                        .HasColumnType("integer");

                    b.Property<DateOnly?>("FirstContactDate")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("FirstProposalDate")
                        .HasColumnType("date");

                    b.Property<double?>("FirstProposalValue")
                        .HasColumnType("double precision");

                    b.Property<int?>("FirstProposalValueCurrncey")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Backend.Models.OpportunityHistory", b =>
                {
                    ...
                    b.Property<int?>("FinalProposalValueCurrncey")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Backend.Models.Project", b =>
                {
                    ...
                    b.Property<DateOnly?>("ClientApprovalDate")
                        .HasColumnType("date");

                    b.Property<int>("ClientId")
                        .HasColumnType("integer");

                    b.Property<DateOnly?>("CompletionDateActual")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("CompletionDateScheduled")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Backend.Models.ProjectMilestone", b =>
                {
                    ...
                    b.Property<DateOnly?>("DateActual")
                        .HasColumnType("date");
